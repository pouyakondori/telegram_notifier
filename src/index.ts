...
async function sendMessage(
  ...
  try {
    ...
    let url = `https://api.telegram.org/bot${telegram_bot_token}/sendMessage?chat_id=${telegram_chat_id}&message_thread_id=${telegram_topic_id}&parse_mode=HTML&text=${message}`;
